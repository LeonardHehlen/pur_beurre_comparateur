...
def main():
    ...
    if request.method == 'POST':
        ...
        item = requests.get("https://fr.openfoodfacts.org//api/v0/produit/" + barcode)

        nutriscore = str(item.json()['product']['nutrition_grade_fr'])

        generic_name = str(item.json()['product']['generic_name'])
